...
banChats = true
offline = false
targetpc = '6285607290187'
owner = '6285607290187'
fake = '*_TITO @tito_o4.o_*'
numbernye = '0'
waktu = '-'
alasan = '-'
...
//FUNCTION
  ...
  // TicTacToe
        ...
        // GAME 
        game.cekWaktuFam(hexa, family100)
        game.cekWaktuTG(hexa, tebakgambar)
        ...
        if (game.isfam(from, family100) && isUser){
            ...
            if (anjuy.length < 1){
                hexa.sendMessage(from, `Semua jawaban sudah tertebak\nKirim *${prefix}family100* untuk bermain lagi`, text)
...
await hexa.updatePresence(from, Presence.available)
...
*</MAKER>*
￫ ${t}${prefix}sticker${t}
￫ ${t}${prefix}swm${t} <author|packname>
￫ ${t}${prefix}take${t} <author|packname>
￫ ${t}${prefix}fdeface${t}
￫ ${t}${prefix}emoji${t}
...
*</DOWNLOAD>*
￫ ${t}${prefix}ytsearch${t} <query>
￫ ${t}${prefix}igstalk${t} <query>
￫ ${t}${prefix}play${t} <query>
￫ ${t}${prefix}video${t} <query>
￫ ${t}${prefix}ytmp3${t} <link>
￫ ${t}${prefix}ytmp4${t} <link>
￫ ${t}${prefix}ig${t} <link>
￫ ${t}${prefix}igstory${t} <username>
￫ ${t}${prefix}twitter${t} <link>
￫ ${t}${prefix}tiktok${t} <link>
￫ ${t}${prefix}tiktokaudio${t} <link>
￫ ${t}${prefix}fb${t} <link>
￫ ${t}${prefix}brainly${t} <query>
￫ ${t}${prefix}image${t} <query>
￫ ${t}${prefix}anime${t} <random>
￫ ${t}${prefix}pinterest${t} <query>
￫ ${t}${prefix}komiku${t} <query>
￫ ${t}${prefix}lirik${t} <query>
￫ ${t}${prefix}chara${t} <query>
￫ ${t}${prefix}playstore${t} <query>
￫ ${t}${prefix}otaku${t} <query>

*</JADI BOT>*
￫ ${t}${prefix}jadibot${t}
￫ ${t}${prefix}stopjadibot${t}
￫ ${t}${prefix}listbot${t}
...
*</UP STORY>*
￫ ${t}${prefix}upswteks${t}
￫ ${t}${prefix}upswimage${t}
￫ ${t}${prefix}upswvideo${t}

*</OTHER>*
￫ ${t}${prefix}self${t}
￫ ${t}${prefix}public${t}
￫ ${t}${prefix}setthumb${t}
￫ ${t}${prefix}settarget${t}
￫ ${t}${prefix}setfakeimg${t}
￫ ${t}${prefix}setreply${t}
￫ ${t}${prefix}ping${t}
￫ ${t}${prefix}inspect${t}
￫ ${t}${prefix}join${t}
￫ ${t}${prefix}caripesan${t} <query>
￫ ${t}${prefix}get${t}
￫ ${t}${prefix}term${t} <code>
￫ ${t}x${t} <code>
...
hx.tebakgambar()
    .then(result => {
     console.log(result)
     sendFileFromUrl(from, result[0].image)
});
    ...
    case 'linkwa':
            ...
            break
  case 'surah':
if(!q) return reply('cari surah apa?, nyarinya pake nomor, misal surah 1')
            hx.surah(q)
            .then(result => {
            let res = `*「 _SURAH ${q}_ 」*\n\n`
            for (let i of result) {
...
const pembawm = args.join('')
		...
		break
            case 'exif':
	        if (!isOwner) return reply('This command only for Tito')
...
if (budy.startsWith('tito')){
try {
return fakestatus('yoi')
} catch(err) {
e = String(err)
reply(e)
}
